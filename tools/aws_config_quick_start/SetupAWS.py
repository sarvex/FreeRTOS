...
def prereq():
    ...
    if not thing_obj.create():
        ...
        cert_id_filename = f'{thing_name}_cert_id_file.txt'
        ...
        cert_pem_filename = f'{thing_name}_cert_pem_file.pem'
        ...
        private_key_pem_filename = f'{thing_name}_private_key_pem_file.pem'
